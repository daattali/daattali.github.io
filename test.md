...
![Tweets score]({{ site.url }}/img/blog/rbloggers-twitter/tweets-score.gif)
...
![Tweets by top-10 authors]({{ site.url }}/img/blog/rbloggers-twitter/posts-top-10.gif)
...
![Tweets by top-10 authors along with all tweets]({{ site.url }}/img/blog/rbloggers-twitter/all-tweets-top-10.gif)
...
![Posts per blog]({{ site.url }}/img/blog/rbloggers-twitter/posts-per-blog.gif)
...
![Tweet score vs day of tweet]({{ site.url }}/img/blog/rbloggers-twitter/score-per-day.gif)
...
![Wordcloud]({{ site.url }}/img/blog/rbloggers-twitter/wordcloud.gif)
