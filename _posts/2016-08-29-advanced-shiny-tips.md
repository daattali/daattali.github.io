...
- Intermediate
  ...
  - [Show user a function's messages and warnings to the user](#show-warnings-messages) ([code](./show-warnings-messages))
...
<h2 id="show-warnings-messages">Show user a function's messages and warnings to the user</h2>
