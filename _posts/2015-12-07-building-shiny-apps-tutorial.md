...
2. [Shiny app basics](#2-shiny-app-basics)
3. [Create an empty Shiny app](#3-create-an-empty-shiny-app)
4. [Load the dataset](#4-load-the-dataset)
5. [Build the basic UI](#5-build-the-basic-ui)
6. [Add inputs to the UI](#6-add-inputs-to-the-ui)
7. [Add placeholders for outputs](#7-add-placeholders-for-outputs)
8. [Checkpoint: what our app looks like after implementing the UI](#8-checkpoint-what-our-app-looks-like-after-implementing-the-ui)
9. [Implement server logic to create outputs](#9-implement-server-logic-to-create-outputs)
10. [Reactivity 101](#10-reactivity-101)
11. [Using uiOutput() to create UI elements dynamically](#11-using-uioutput-to-create-ui-elements-dynamically)
12. [Final Shiny app code](#12-final-shiny-app-code)
13. [Share your app with the world](#13-share-your-app-with-the-world)
14. [More Shiny features to check out](#14-more-shiny-features-to-check-out)
15. [Awesome add-on packages to Shiny](#15-awesome-add-on-packages-to-shiny)
16. [Resources](#16-resources)
17. [Ideas to improve our app](#17-ideas-to-improve-our-app)
...
> If you look at that input function and think "what if there were 100 types, listing them by hand would not be fun, there's got to be a better way!", then you're right.  This is where [`uiOutput()`](#11-using-uioutput-to-create-ui-elements-dynamically) comes in handy, but we'll talk about that later.
...
You can include Shiny inputs and outputs in an Rmarkdown document! This means that your Rmarkdown document can be interactive. Learn more [here](http://rmarkdown.rstudio.com/authoring_shiny.html). Here's a simple example of how to include interactive Shiny elements in an Rmarkdown.
